...
- `EventSpan.ALL_EVENTS` for deleting an entire recurring series
...
- Android recurring delete: `THIS_EVENT` creates a canceled exception for the occurrence; `THIS_AND_FUTURE_EVENTS` truncates the series instead of deleting the master
